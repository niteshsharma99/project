...
public class EmployeeResource {
    ...
    public ResponseEntity<Employee> updateEmployee(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, employee.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, employee.getId())
        );
    }
